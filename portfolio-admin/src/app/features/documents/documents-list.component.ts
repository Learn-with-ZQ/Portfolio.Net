...
export class DocumentsListComponent {
  ...
  readonly displayedColumns = ['documentTitle', 'documentType', 'fileName', 'isPublic', 'versionNumber', 'actions'];
  ...
  load(): void {
    ...
    this.api
      ...
      .subscribe({
        next: (result: PagedResult<Document>) => {
  ...
  deleteItem(item: Document): void {
    const ref = this.dialog.open(ConfirmDialogComponent, {
      data: {
        title: 'Delete Document',
        message: `Are you sure you want to delete "${item.documentTitle}"?`
      }
    });
    ...
    ref.afterClosed().subscribe((confirmed) => {
      ...
      this.api.delete(item.documentId).subscribe({
        next: () => {

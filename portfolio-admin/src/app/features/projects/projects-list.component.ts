...
export class ProjectsListComponent {
  ...
  readonly displayedColumns = ['projectName', 'contextName', 'technologies', 'startDate', 'endDate', 'actions'];
  ...
  load(): void {
    ...
    this.api
      ...
      .subscribe({
        next: (result: PagedResult<Project>) => {
  ...
  deleteItem(item: Project): void {
    const ref = this.dialog.open(ConfirmDialogComponent, {
      data: {
        ...
        message: `Are you sure you want to delete "${item.projectName}"?`
      }
    });
    ...
    ref.afterClosed().subscribe((confirmed) => {
      ...
      this.api.delete(item.projectId).subscribe({
        next: () => {
